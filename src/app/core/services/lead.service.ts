    ...
    createLead(lead: Partial<Lead>): Observable<Lead> {
        ...
        const formattedLead = {
        ...this.formatLeadForDatabase(lead),
    ...
    private formatLeadForDatabase(lead: Partial<Lead>): any {
        ...
        if (lead.company_id !== undefined) result.company_id = lead.company_id;
        ...
        if (lead.assigned_to !== undefined) result.assigned_to = lead.assigned_to;
